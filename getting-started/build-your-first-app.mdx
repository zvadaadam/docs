...
<Info>
  You can start on desktop (the web app at{" "}
  <a href="https://steercode.com" target="_blank" rel="noreferrer">
    steercode.com
  </a>
  ) or on iPhone (the iOS app in the{" "}
  <a
    href="https://apps.apple.com/us/app/id6742994386"
    target="_blank"
    rel="noreferrer"
  >
    App Store
  </a>
  ). See <a href="/getting-started/create-anywhere">Create Anywhere</a> for
  details.
</Info>

<Steps>
<Step title="Sign in">
Go to <a href="https://steercode.com" target="_blank" rel="noreferrer">steercode.com</a> (or open the iOS app) and sign in.
